...
export default function HotelDescriptionForm({ selectedSection }) {
    ...
    return (
        <div
            className={selectedSection === "-description" ? "block" : "hidden"}
        >
            <div>
            ...
            <div className="mt-[3em]">
                ...
                >
                    <button
                        ...
                        onClick={() =>
                            setHotelFaqModal({ isOpen: true, isEdit: false })
                        }
                    >
                        + Add FAQ
                    </button>
