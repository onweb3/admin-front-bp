        ...
        <tr className="border-b border-tableBorderColor">
          <td colSpan="8" className="p-3">
            <div className="flex flex-wrap items-start gap-x-[3em] gap-y-[1.5em]">
              ...
              <div>
                <h2 className="font-medium text-grayColor">Transfer Type</h2>

                <span className="flex items-center gap-[7px] mt-2 capitalize">
                  <MdTransferWithinAStation /> {order?.transferType} Transfer
                </span>
              </div>
              {order?.trips.map((trip, index) => {
                return (
                  <div>
                    <h2 className="font-medium text-grayColor">
                      Trip - {index === 0 ? "oneway" : "return"}
                    </h2>

                    <span className="block mt-2">
                      <span className="text-grayColor">Suggestion -</span>{" "}
                      {trip?.suggestionType}
                    </span>
                    <span className="block mt-2">
                      <span className="text-grayColor">Pickup Location -</span>{" "}
                    ...
                    <span className="block mt-2">
                      <span className="text-grayColor">Pickup Date -</span>{" "}
                      {formatDate(trip?.pickupDate)}
                    </span>
                    <span className="block mt-2">
                      <span className="text-grayColor">Pickup Time - -</span>{" "}
                      {trip?.pickupTime}
                    </span>
                    <span className="block mt-2">
                      <span className="text-grayColor">Vehicle Type - -</span>{" "}
                      {trip?.vehicleType?.name}
                    </span>
                    <span className="block mt-2">
                      <span className="text-grayColor">Occupancy - -</span>{" "}
                      {trip?.occupancy}
                    </span>
                  </div>
                );
