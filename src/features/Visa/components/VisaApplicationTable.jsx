  ...
  return (
    ...
    >
      ...
      <td className="p-3">
        ...
        <span className="text-grayColor block">{visaApplication?.visa}</span>
      </td>
      ...
      {orderedBy == "b2c" ? (
        <td className="p-3">
          <span className="block">{visaApplication?.user?.name} </span>
        ...
        <td className="p-3">
          <span className="block">{visaApplication?.reseller?.name} </span>
          <span className="text-grayColor block">
      ...
      <td className="p-3">
        { visaApplication?.travellers?.isStatus === "approved" ? (
          <div>
            <span className="py-1 px-2 text-[12px] font-medium rounded text-[#008000] bg-[#f065481a]">
              Approved
            </span>
          </div>
        ) : visaApplication?.travellers?.isStatus === "rejected" ? (
          <div>
        ...
        visaApplication?.travellers?.isStatus === "submitted" ? (
          <div>
