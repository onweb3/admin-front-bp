      ...
      >
        ...
        <div className="flex items-center justify-between border-b p-4">
          ...
          <div className="flex bg-gray-50 shadow-sm">
            <div className="w-[300px] h-auto  text-textColor flex text-sm font-[500]  items-center justify-center ">
              <div className="flex item-center ">Arrival Date</div>
            ...
            <div className="w-[300px] h-auto text-textColor text-sm font-[500]  flex justify-center items-center ">
              <div className="flex item-center p-4">Departure Date</div>
              <div className="flex item-center p-4">
            ...
            <div className="grid grid-cols-3 gap-5 z-10">
              <div className=" items-start gap-[2em] mt-6">
                ...
                <div className=" w-full">
                  <input
                    type="date"
                    min={checkInDate ? formatDate(checkInDate) : ""}
                    max={checkOutDate ? formatDate(checkOutDate) : ""}
                    onChange={(e) => {
        ...
        {next === false ? (
          <>
                    ...
                    availableHotels?.map((hotel, hotelIndex) => (
                      <div
                        ...
                        onClick={() => {
                          ...
                          onClickHandler({
                            name: "areaName",
                            value: hotel?.hotel?.area?.areaName,
                          });
            ...
            {buttonHidden ? (
              <>
                {filters?.totalHotels > 5 && availableHotels.length > 0 ? (
                  <div className="p-4">
                    <Pagination
                      limit={filters?.limit}
                      skip={filters?.skip}
          ...
          <>
            <div>
                  ...
                  <div className="pt-4">
                    <div className="grid grid-cols-4 gap-2 items-center">
                      {selectedHotel?.roomTypes?.map((roomType) => (
                        <div
                          onClick={() => {
                            setSetSelectedRoomType(roomType);
                            onClickHandler({
                              name: "roomTypeName",
              ...
              {selectedRoomType.length !== 0 ? (
                <div className="py-5 ">
                  ...
                  <div className="pt-4">
                    <div className="grid grid-cols-4 gap-2 items-center">
                      {selectedRoomType?.boardTypes?.map((boardType) => (
                        <div
                          onClick={() => {
            ...
            <div className="flex justify-end gap-4">
              ...
              {data.boardTypeCode && data.roomTypeId && data.hotelId ? (
                <>
                  {" "}
                  {isNotAvailable ? (
                    <div className="flex justify-end mt-6">
                      ...
                      >
                        {isSubmitLoading ? <BtnLoader /> : "Confirm Hotel "}
                      </button>
                    </div>
                  ) : (
                    <div className="flex justify-end mt-6">
