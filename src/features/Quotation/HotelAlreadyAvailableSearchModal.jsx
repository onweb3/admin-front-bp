          ...
          <div className="w-full">
            ...
            <div className="grid grid-cols-3 gap-5 z-10">
              <div className=" items-start gap-[2em] mt-6">
                ...
                <div className=" w-full">
                  <input
                    ...
                    min={
                      data?.checkInDate
                        ? new Date(data?.checkInDate).toJSON().slice(0, 10)
                        : new Date().toJSON().slice(0, 10)
                    }
                    max={
                      data?.checkOutDate
                        ? new Date(data?.checkOutDate).toJSON().slice(0, 10)
                        : new Date().toJSON().slice(0, 10)
                    }
                    onChange={(e) => {
              ...
              <div className="flex justify-end mt-12">
                ...
                >
                  {setIsAvailablityLoading === true ? <BtnLoader /> : "Search"}
                </button>
              </div>
            </div>
          </div>
