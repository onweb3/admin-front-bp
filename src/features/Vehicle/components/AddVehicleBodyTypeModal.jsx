...
export default function AddVehicleBodyTypeModal({
  ...
  const [data, setData] = useState({
    bodyType:
      (vehicleBodyTypesModal?.isEdit && selectedVehicleBodyType?.bodyType) ||
      "",
    bodyImg:
      (vehicleBodyTypesModal?.isEdit && selectedVehicleBodyType?.bodyImg) || "",
  });
                  ...
                  <img
                    src={
                      bodyImg
                        ...
                        : import.meta.env.VITE_SERVER_URL + data.bodyImg
                    }
