            ...
            <img
              src={
                newImages && newImages[0]
                  ...
                  : import.meta.env.VITE_SERVER_URL + data?.thumbnail[0]
              }
              alt=""
                  ...
                  <div className="flex items-start mb-5 last:mb-0 gap-4">
                    ...
                    <div className="border p-3 w-full relative">
                      ...
                      <p className="mt-2 text-sm leading-6">
                        At the time of your arrival our driver will greet you &
                        assist you with your baggage to the Vehicle and drive
                        you safely to your Hotel or Residence.
                      </p>
                    </div>
                  </div>
                )}
                ...
                {airportDropOff && (
                  <div className="flex items-start mb-5 last:mb-0 gap-4">
                    ...
                    <div className="border p-3 w-full relative">
                      ...
                      <p className="mt-2 text-sm leading-6">
                        At the time of your departure Our Driver will Pick you
                        from your desired hotel in Dubai and drop you at the
