    ...
    return (
        <div>
            <div className="bg-white flex items-center justify-between gap-[10px] px-6 shadow-sm border-t py-2">
                <h1 className="font-[600] text-[15px] uppercase">Tour Package Details</h1>
                ...
                <div className="p-6">
                    <div className="bg-white rounded shadow-sm p-4">
                        <div className="relative flex flex-col items-center justify-center bg-slate-300 w-full h-[200px] rounded">
                            {tourPackage?.thumbnail && (
                                <div className="absolute inset-0">
                                    <img
                                        src={config.SERVER_URL + tourPackage?.thumbnail}
                                        alt=""
                            ...
                            <div className="z-10 text-center">
                                ...
                                <span className="text-sm block mt-1">
                                    {tourPackage?.noOfDays || "N/A"} Days - Availability (
                                    {tourPackage?.isCustomDate === true ? "Custom" : "All Day"})
                                </span>
                            </div>
                        </div>
                        ...
                        <div className="mt-10">
                            ...
                            <p className="text-sm leading-7">{tourPackage?.overveiw}</p>
                        </div>
                        ...
                        <div className="mt-10">
                            ...
                            {tourPackage?.itineraries?.length < 1 ? (
                                ...
                                tourPackage?.itineraries?.map((itinerary, itineraryIndex) => {
                                    const airportPickup =
                                        itineraryIndex === 0 &&
                                        tourPackage?.isAirportTransfer === true;
                                    const airportDropOff =
                                        itineraryIndex === tourPackage?.itineraries?.length - 1 &&
                                        tourPackage?.isAirportTransfer === true;
                                        ...
                                        >
                                            ...
                                            /> */}
                                                    ...
                                                    <div className="border p-3 w-full relative">
                                                        ...
                                                        <p className="mt-2 text-sm leading-6">
                                                            At the time of your arrival our driver
                                                            will greet you & assist you with your
                                                            baggage to the Vehicle and drive you
                                                            safely to your Hotel or Residence.
                                                        </p>
                                                    </div>
                                                </div>
                                            )}
                                            ...
                                            /> */}
                                                    ...
                                                    <div className="border p-3 w-full relative">
                                                        ...
                                                        <p className="mt-2 text-sm leading-6">
                                                            At the time of your departure Our Driver
                                                            will Pick you from your desired hotel in
                                                            Dubai and drop you at the Dubai
                        ...
                        <div className="mt-10">
                            ...
                            {tourPackage?.hotels?.map((tpHotel, tpHotelIndex) => {
                                let lastNight =
                                    (tpHotelIndex !== 0 &&
                                        tourPackage?.hotels[tpHotelIndex - 1]?.noOfNights - 1) ||
                                    0;
