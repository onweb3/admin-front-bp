...
export default function EditInitialDataPage() {
  ...
  const handleSubmit = async (e) => {
    try {
      ...
      formData.append("PAYPAL_CLIENT_SECRET", data.PAYPAL_CLIENT_SECRET || "");
      formData.append("EMAIL", data.EMAIL || "");
      formData.append("PASSWORD", data.PASSWORD || "");
      formData.append("CCAVENUE_MERCHANT_ID", data.CCAVENUE_MERCHANT_ID || "");
      formData.append("CCAVENUE_ACCESS_CODE", data.CCAVENUE_ACCESS_CODE || "");
      formData.append("CCAVENUE_WORKING_KEY", data.CCAVENUE_WORKING_KEY || "");
      formData.append("RAZORPAY_KEY_ID", data.RAZORPAY_KEY_ID || "");
      formData.append("RAZORPAY_KEY_SECRET", data.RAZORPAY_KEY_SECRET || "");
      ...
      formData.append("INSURANCE_SERVER_URL", data.INSURANCE_SERVER_URL || "");
      formData.append("WHATSAPP_SERVER_URL", data.WHATSAPP_SERVER_URL || "");
      ...
      formData.append("HOTEL_BEDS_API_KEY", data.HOTEL_BEDS_API_KEY || "");
  ...
  const handleB2bSubmit = async (e) => {
    try {
      ...
      formData.append("GOOGLE_CLIENT_SECRET", data?.GOOGLE_CLIENT_SECRET || "");
      ...
      formData.append("NEXT_PUBLIC_CDN_URL", data?.NEXT_PUBLIC_CDN_URL || "");
      formData.append(
        "NEXT_PUBLIC_TITLE_NAME",
      ...
      formData.append("NEXT_PUBLIC_BANNER_VIDEO_MOBILE", bannerMobVid || "");
      formData.append("NEXT_PUBLIC_BANNER_IMAGE_MOBILE", bannerImgMob || "");
  ...
  const handleB2cSubmit = async (e) => {
    try {
      ...
      formData.append("B2C_TITLE_SHORT_NAME", data?.B2C_TITLE_SHORT_NAME || "");
      formData.append(
        "B2C_COMPANY_SHORT_CODE",
        data?.B2C_COMPANY_SHORT_CODE || ""
      );
      formData.append("B2C_COMPANY_B2B_URL", data?.B2C_COMPANY_B2B_URL || "");
      ...
      formData.append("B2C_MOBILE_APP_IMAGE", data?.B2C_MOBILE_APP_IMAGE || "");
      ...
      formData.append("B2C_COMPANY_FAVICON", data?.B2C_COMPANY_FAVICON || "");
      ...
      formData.append("B2C_CONTACTUS_EMAIL", data?.B2C_CONTACTUS_EMAIL || "");
      formData.append("B2C_ENQUIRY_EMAIL", data?.B2C_ENQUIRY_EMAIL || "");
      formData.append("B2C_COMPANY_ADDRESS", data?.B2C_COMPANY_ADDRESS || "");
      formData.append("B2C_COMPANY_CITY", data?.B2C_COMPANY_CITY || "");
      formData.append("B2C_COMPANY_PINCODE", data?.B2C_COMPANY_PINCODE || "");
      formData.append("B2C_COMAPNY_COUNTRY", data?.B2C_COMAPNY_COUNTRY || "");
      ...
      {isPageLoading ? (
        ...
        <div className="p-6">
          <div className="bg-white rounded p-6 shadow-sm">
            <div className="flex items-center gap-[13px] px-4 border-b border-b-dahsed">
              <button
                className={
                  ...
                  (section === "server" ? "border-b border-b-orange-500" : "")
                }
                onClick={(e) => {
            ...
            <div className={` ${section === "server" ? "" : "hidden"}`}>
              <form action="" onSubmit={handleSubmit}>
                <div>
                  {" "}
                  <h1 className="font-[600] text-[15px] pt-10">BASIC DATA</h1>
                </div>
                <div className="grid grid-cols-3 gap-4 mt-5">
                  ...
                  <div>
                    <label htmlFor="">Company Registration Name</label>
                    <input
                      type="text"
                      placeholder="Enter registration name"
                      name="COMPANY_REGISTRATION_NAME"
                      value={data.COMPANY_REGISTRATION_NAME || ""}
                      onChange={handleChange}
                      required
                    />
                  </div>{" "}
                ...
                <div>
                  {" "}
                  <h1 className="font-[600] text-[15px] mt-5">CREDENTIALS</h1>
                </div>
                <div className="grid grid-cols-3 gap-4 mt-5">
                  <div>
                  ...
                  <div>
                    <label htmlFor="">PayPal Clinet Secret</label>
                    <input
                      type="text"
                ...
                <div className="grid grid-cols-3 gap-4 mt-5">
                  <div>
                    <label htmlFor="">CC Avenue Merchant Id</label>
                    <input
                      type="text"
                  ...
                  <div>
                    <label htmlFor="">CC Avenue Access Code </label>
                    <input
                      type="text"
                  ...
                  <div>
                    <label htmlFor="">CC Avenue Working Key </label>
                    <input
                      type="text"
                ...
                <div className="grid grid-cols-3 gap-4 mt-5">
                  <div>
                    <label htmlFor="">Burjkhalifa Username</label>
                    <input
                      type="text"
                  ...
                  <div>
                    <label htmlFor="">Burjkhalifa Password</label>
                    <input
                      type="text"
            ...
            <div className={` ${section === "b2b" ? "" : "hidden"}`}>
              <form action="" onSubmit={handleB2bSubmit}>
                ...
                <div className="grid grid-cols-3 gap-4 mt-5">
                  <div>
                    ...
                    <input
                      ...
                      value={data.NEXT_PUBLIC_TITLE_NAME || ""}
                      onChange={handleChange}
                      required
                    />
                  </div>
                  <div>
                    ...
                    <input
                      ...
                      value={data.NEXT_PUBLIC_TITLE_SHORT_NAME || ""}
                      onChange={handleChange}
                      required
                    />
                  </div>
                  <div>
                    <label htmlFor="">Company Short Code</label>
                    <input
                      type="text"
                      placeholder="Enter airline code"
                      name="NEXT_PUBLIC_TITLE_SHORT_CODE"
                      value={data.NEXT_PUBLIC_TITLE_SHORT_CODE || ""}
                      onChange={handleChange}
                      required
                    />
                  </div>
                  ...
                  <div className="mt-4">
                    ...
                    {(logoImg || data.NEXT_PUBLIC_COMPANY_LOGO) && (
                      <div className="mt-4 w-[50px] h-[50px]">
                        <img
                          src={
                            image
                  ...
                  <div className="mt-4">
                    ...
                    {(image || data.NEXT_PUBLIC_COMPANY_FAVICON) && (
                      <div className="mt-4 w-[50px] h-[50px]">
                        <img
                          src={
                            image
                ...
                <div>
                  {" "}
                  <h1 className="font-[600] text-[15px] mt-5">DATA</h1>
                </div>
                <div className="grid grid-cols-3 gap-4 mt-5">
                  <div>
                    <label htmlFor="">Cloudinary Cloud Name</label>
                    <input
                      type="text"
                      placeholder="cloudinary name "
                      name="NEXT_PUBLIC_CLOUDINARY_CLOUD_NAME"
                      value={data.NEXT_PUBLIC_CLOUDINARY_CLOUD_NAME || ""}
                      onChange={handleChange}
                    />
                  </div>
                  <div>
                    <label htmlFor="">Cloudinary API Key</label>
                    <input
                      type="text"
                  ...
                  <div>
                    <label htmlFor="">Cloudinary Api Secret</label>
                    <input
                      type="text"
                  ...
                  <div>
                    <label htmlFor="">Cloudinary Folder</label>
                    <input
                      type="text"
                      placeholder="Enter password"
                ...
                <div className="grid grid-cols-3 gap-4 mt-5">
                  ...
                  <div>
                    <label htmlFor="">Google Client Secret</label>
                    <input
                      type="text"
                      placeholder="Enter google analytics ID"
                ...
                <div className="grid grid-cols-3 gap-4 mt-5">
                  <div>
                    ...
                    <input
                      ...
                      value={data.NEXT_PUBLIC_GOOGLE_ANALYTIC_ID || ""}
                      onChange={handleChange}
                    />
                  </div>
                </div>{" "}
                <div className="grid grid-cols-3 gap-4 mt-5">
                  <div>
                    ...
                    <input
                      ...
                      value={data.NEXT_PUBLIC_TABBY_PUBLIC_KEY || ""}
                      onChange={handleChange}
                    />
                  </div>
                  <div>
                    <label htmlFor=""> Tabby Merchant Code</label>
                    <input
                      type="text"
                      placeholder="Enter tabby merchant code"
                      name="NEXT_PUBLIC_TABBY_MERCHANT_CODE"
                      value={data.NEXT_PUBLIC_TABBY_MERCHANT_CODE || ""}
                      onChange={handleChange}
                    />
                  </div>
                </div>{" "}
                <div className="grid grid-cols-3 gap-4 mt-5">
                  <div>
                    ...
                    <input
                      ...
                      value={data.NEXT_PUBLIC_TOURS_URL || ""}
                      onChange={handleChange}
                    />
                  </div>
                  <div>
                    ...
                    <input
                      ...
                      placeholder="Enter tabby merchant code"
                      name="NEXT_PUBLIC_TABBY_MERCHANT_CODE"
                      value={data.NEXT_PUBLIC_SERVER_URL || ""}
                      onChange={handleChange}
                    />
                  </div>{" "}
                  <div>
                    ...
                    <input
                      ...
                      value={data.NEXT_PUBLIC_CLIENT_URL || ""}
                      onChange={handleChange}
                    />
                  </div>{" "}
                  <div>
                    ...
                    <input
                      ...
                      value={data.NEXT_PUBLIC_CDN_URL || ""}
                      onChange={handleChange}
                    />
                  </div>
                  <div>
                    ...
                    <input
                      ...
                      value={data.NEXT_PUBLIC_PLAYSTORE_URL || ""}
                      onChange={handleChange}
                    />
                  </div>
                </div>{" "}
                <div className="grid grid-cols-3 gap-4 mt-5">
                  <div>
                    ...
                    <input
                      ...
                      value={data.NEXT_PUBLIC_COMPANYADDRESS1 || ""}
                      onChange={handleChange}
                    />
                  </div>
                  <div>
                    ...
                    <input
                      ...
                      value={data.NEXT_PUBLIC_COMPANYADDRESS2 || ""}
                      onChange={handleChange}
                    />
                  </div>
                </div>
                <div className="mt-4">
                  ...
                  {(bannerImg || data.NEXT_PUBLIC_BANNER_IMAGE) && (
                    <div className="mt-4 w-[50px] h-[50px]">
                      <img
                        src={
                          image
                ...
                <div className="mt-4">
                  ...
                  <input type="file" onChange={handleBannerMobImgChange} />
                  {logoBanMobImgError && (
                    <span className="block text-sm text-red-500 mt-2">
                      {logoBanMobImgError}
                    </span>
                  )}
                  {(bannerImgMob || data.NEXT_PUBLIC_BANNER_IMAGE_MOBILE) && (
                    <div className="mt-4 w-[50px] h-[50px]">
                      <img
                        src={
                          image
                ...
                <div className="mt-4">
                  ...
                  <input type="file" onChange={handleAppImgChange} />
                  {logoAppImgError && (
                    <span className="block text-sm text-red-500 mt-2">
                      {logoAppImgError}
                    </span>
                  )}
                  {(appImg || data.NEXT_PUBLIC_BANNER_IMAGE) && (
                    <div className="mt-4 w-[50px] h-[50px]">
                      <img
                        src={
                          appImg
                            ? URL.createObjectURL(appImg)
                            : import.meta.env.VITE_SERVER_URL +
                ...
                <div>
                  <div className="mt-4">
                    ...
                    <input type="file" onChange={handleBannerVidChange} />
                  </div>
                  {(bannerVid || data.NEXT_PUBLIC_BANNER_VIDEO) && (
                    <div className="mt-4 w-[50px] h-[50px]">
                      <video
                        src={
                          bannerVid
                            ? URL.createObjectURL(bannerVid)
                            : config?.SERVER_URL + data.NEXT_PUBLIC_BANNER_VIDEO
                        }
                        className="w-[100%] h-[100%] object-cover"
                ...
                <div>
                  <div className="mt-4">
                    <label htmlFor="">Banner Video Mobile</label>
                    <input type="file" onChange={handleBannerMobVidChange} />
                  </div>
                  {(bannerMobVid || data.NEXT_PUBLIC_BANNER_VIDEO_MOBILE) && (
                    <div className="mt-4 w-[50px] h-[50px]">
                      <video
                        src={
                          bannerMobVid
                            ? URL.createObjectURL(bannerMobVid)
                            : config?.SERVER_URL +
                ...
                <div className="mt-4 flex items-center justify-end gap-[12px]">
                  ...
                  <button className="w-[130px]">
                    {isLoading ? <BtnLoader /> : "Update B2b"}
                  </button>
                </div>
              </form>
            </div>
            <div className={` ${section === "b2c" ? "" : "hidden"}`}>
              <form action="" onSubmit={handleB2cSubmit}>
                ...
                <div className="grid grid-cols-3 gap-4 mt-5">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      value={data.B2C_TITLE_SHORT_NAME || ""}
                      onChange={handleChange}
                      required
                    />
                  </div>
                  <div>
                    ...
                    <input
                      ...
                      value={data.B2C_COMPANY_SHORT_CODE || ""}
                      onChange={handleChange}
                      required
                    />
                  </div>{" "}
                ...
                <div className="grid grid-cols-3 gap-4 mt-5">
                  ...
                  <div>
                    <label htmlFor=""> Company B2B URL </label>
                    <input
                      type="text"
                      placeholder="Enter tabby merchant code"
                      name="B2C_COMPANY_B2B_URL"
                      value={data.B2C_COMPANY_B2B_URL || ""}
                      onChange={handleChange}
                    />
                  </div>
                  <div>
                ...
                <div className="grid grid-cols-3 gap-4 mt-5">
                  ...
                  <div>
                    <label htmlFor="">Contact Us Email</label>
                    <input
                      type="text"
                      placeholder="company address"
                      name="B2C_CONTACTUS_EMAIL"
                      value={data.B2C_CONTACTUS_EMAIL || ""}
                      onChange={handleChange}
                    />
                  </div>{" "}
                  <div>
                  ...
                  <div>
                    <label htmlFor="">Company Facebook</label>
                    <input
                      type="text"
                      placeholder="company address"
                  ...
                  <div>
                    <label htmlFor="">Company Instagram</label>
                    <input
                      type="text"
                      placeholder="company address"
                ...
                <div className="grid grid-cols-3 gap-4 mt-5">
                  <div>
                    <label htmlFor="">Company Number 1</label>
                    <input
                      type="text"
                      placeholder="company address"
                      name="B2C_COMPANY_CONTACT_NUMBER_ONE"
                      value={data.B2C_COMPANY_CONTACT_NUMBER_ONE || ""}
                      onChange={handleChange}
                    />
                  </div>
                  <div>
                    <label htmlFor="">Company Number 2</label>
                    <input
                      type="text"
                      placeholder="company address"
                      name="B2C_COMPANY_CONTACT_NUMBER_TWO"
                      value={data.B2C_COMPANY_CONTACT_NUMBER_TWO || ""}
                      onChange={handleChange}
                    />
                  </div>{" "}
                  <div>
                    <label htmlFor="">Company Whatsapp</label>
                    <input
                      type="text"
                      placeholder="company address"
                      name="B2C_COMPANY_WHATSAPP_NUMBER"
                      value={data.B2C_COMPANY_WHATSAPP_NUMBER || ""}
                      onChange={handleChange}
                    />
                  </div>
                </div>
                <div className="grid grid-cols-3 gap-4 mt-5">
                  <div>
                    ...
                    <input
                      ...
                      value={data.B2C_COMPANY_ADDRESS || ""}
                      onChange={handleChange}
                    />
                  </div>
                  <div>
                  ...
                  <div>
                    <label htmlFor="">Company Pincode</label>
                    <input
                      type="text"
                      placeholder="company address"
                      name="B2C_COMPANY_PINCODE"
                      value={data.B2C_COMPANY_PINCODE || ""}
                      onChange={handleChange}
                    />
                  </div>
                  <div>
                    ...
                    <input
                      ...
                      value={data.B2C_COMAPNY_COUNTRY || ""}
                      onChange={handleChange}
                    />
                  </div>
                </div>
                ...
                <div className="mt-4 flex items-center justify-end gap-[12px]">
                  ...
                  <button className="w-[130px]">
                    {isLoading ? <BtnLoader /> : "Update B2c"}
                  </button>
                </div>
              </form>
            </div>
