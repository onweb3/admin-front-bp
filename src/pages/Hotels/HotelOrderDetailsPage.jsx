                            ...
                            <tr className="odd:bg-[#f3f6f9]">
                              ...
                              <td className="capitalize">
                                {hotelOrder?.travellerDetails
                                  ?.filter((traveller) => {
                                    return traveller?.roomId === index + 1;
                                  })
                              ...
                              <tr key={index} className="odd:bg-[#f3f6f9]">
                                ...
                                <td className="p-2">
                                  {contract?.isSpecialRate === true
                                    ? "Yes"
                                    : "No"}{" "}
                                  {(contract?.isSpecialRate === true) === true
                            ...
                            (mealUpgrade, index) => {
                              return (
                                <tr key={index} className="odd:bg-[#f3f6f9]">
                                  ...
                                  <td className="p-2">
                                    {mealUpgrade?.dates?.map((item, index) => {
                                      return (
                                        <span key={index}>
                                          {formatDate(item)}
                                          {index <
                                            mealUpgrade?.dates?.length - 1 &&
                                            ", "}
                                        </span>
                                      );
                                    })}
