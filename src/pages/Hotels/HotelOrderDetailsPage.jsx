                        ...
                        <div className="bg-white p-4 shadow-sm rounded">
                            <div className="flex items-start justify-between gap-[20px]">
                                ...
                                <div className="flex items-center gap-[25px]">
                                    ...
                                    <div className="text-center">
                                        ...
                                        >
                                            {hotelOrder?.isCancellationPending ===
                                                true &&
                                            (hotelOrder?.status === "booked" ||
                                                hotelOrder?.status ===
                                                    "confirmed")
                            ...
                            <div className="mt-6 grid grid-cols-2 gap-6 w-full">
                                <div>
                                    ...
                                    <div>
                                        {hotelOrder?.mandatoryAddOns?.length >
                                            0 && (
                                            <div className="mt-7">
                                        ...
                                        {hotelOrder?.addOnSupplements?.length >
                                            0 && (
                                            <div className="mt-7">
                                                <h1 className="font-[600] flex items-center gap-[10px] text-[15px] mb-2">
                                                    <BsFillArrowRightCircleFill />{" "}
                                        ...
                                        {hotelOrder?.appliedPromotions?.length >
                                            0 && (
                                            <div className="mt-7">
                                                <h1 className="font-[600] flex items-center gap-[10px] text-[15px] mb-2">
                                                    <BsFillArrowRightCircleFill />{" "}
                                    ...
                                    <table className="w-full text-[15px]">
                                        <tbody>
                                            ...
                                            <tr className="odd:bg-[#f3f6f9]">
                                                ...
                                                <td>
                                                    {hotelOrder?.totalAdults}{" "}
                                                    Adults,{" "}
                                                    {hotelOrder?.totalChildren}{" "}
                                                    Children
                                                </td>
                                            </tr>
                                            {hotelOrder?.rooms?.map(
                                                (room, index) => {
                                                    return (
                                                        <React.Fragment
                                                            key={index}
                            ...
                            <div className="mt-7">
                                <h1 className="font-[600] flex items-center gap-[10px] text-[15px] mb-2">
                                    <BsFillArrowRightCircleFill /> Cancellation
                                    Requests
                                </h1>
                            ...
                            <div className="mt-7">
                                ...
                                {selectedSection === "discounts" && (
                                    <div className="overflow-x-auto mt-2">
                                        {hotelOrder?.appliedDiscounts?.length <
                                        1 ? (
                                            <div className="p-4 flex flex-col items-center">
                                                <span className="text-sm text-grayColor block mt-[6px]">
                                ...
                                {selectedSection === "meal-upgrades" && (
                                    <div className="overflow-x-auto mt-2">
                                        {hotelOrder?.appliedMealUpgrades
                                            ?.length < 1 ? (
                                            <div className="p-4 flex flex-col items-center">
                                                <span className="text-sm text-grayColor block mt-[6px]">
                                                    Oops.. No Meal Upgrades
                                                    Found
                                                </span>
                                            </div>
                                        ) : (
                                ...
                                {selectedSection === "room-upgrades" && (
                                    <div className="overflow-x-auto mt-2">
                                        {hotelOrder?.appliedRoomTypeUpgrades
                                            ?.length < 1 ? (
                                            <div className="p-4 flex flex-col items-center">
                                                <span className="text-sm text-grayColor block mt-[6px]">
                                                    Oops.. No Room Upgrades
                                                    Found
                                                </span>
                                            </div>
                                        ) : (
                                ...
                                {selectedSection === "staypays" && (
                                    <div className="overflow-x-auto mt-2">
                                        {hotelOrder?.appliedStayPays?.length <
                                        1 ? (
                                            <div className="p-4 flex flex-col items-center">
                                                <span className="text-sm text-grayColor block mt-[6px]">
