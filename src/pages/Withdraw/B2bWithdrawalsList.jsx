    ...
    const fetchWalletWithdrawals = async ({
        ...
        try {
            ...
            const response = await axios.get(
                `/wallets/b2b/withdrawals/all?status=${status}&paymentProcessor=${paymentProcessor}&dateFrom=${dateFrom}&dateTo=${dateTo}&limit=${limit}&skip=${skip}&bankId=${bankId}&referenceNo=${referenceNo}&agentCode=${agentCode}`,
                {
