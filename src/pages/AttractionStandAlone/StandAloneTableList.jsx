...
function StandAloneTableList({ ele }) {
        ...
        try {
            ...
            if (isConfirm) {
                const res = await axios.patch(
                    `/attractions/standalone/delete/${id}`,
                    {},
                    {
    ...
    return (
        <tr className="border-b border-tableBorderColor">
            ...
            <td className="p-3 capitalize">
                <img
                    className="w-44 h-12 object-fill"
                    src={import.meta.env.VITE_SERVER_URL + ele?.images[0]}
                    alt=""
                />
            </td>
            <td className="p-3">
                <div className="flex gap-[10px]">
                    ...
                    <button
                        ...
                        onClick={() =>
                            navigate(`/attractions/standalone/edit/${ele?._id}`)
                        }
                    >
                        <BiEditAlt />
                    </button>
