...
export default function EditCardSettingsB2cPage() {
  ...
  const handleSubmit = async (e) => {
    try {
      ...
      await axios.patch(`/frontend/b2c/home/cards/update/${id}`, formData, {
  ...
  const fetchCard = async () => {
    try {
      ...
      const response = await axios.get(`/frontend/b2c/home/cards/${id}`, {
        headers: { authorization: `Bearer ${jwtToken}` },
      });
                    ...
                    <img
                      src={
                        icon
                          ...
                          : import.meta.env.VITE_SERVER_URL + data.iconUrl
                      }
                      alt=""
                      className="w-full h-full object-cover"
                    />
