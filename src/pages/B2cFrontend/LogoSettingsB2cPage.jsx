...
export default function LogoSettingsB2cPage() {
  ...
  const fetchLogo = async () => {
    try {
      const response = await axios.get("/frontend/b2c/home/logo", {
  ...
  return (
    <div>
      <div className="bg-white flex items-center justify-between gap-[10px] px-6 shadow-sm border-t py-2">
        <h1 className="font-[600] text-[15px] uppercase">Logo Setting</h1>
              ...
              <img
                src={
                  logoImg
                    ...
                    : import.meta.env.VITE_SERVER_URL + logoUrl
                }
                className="w-[250px]"
                alt=""
              />
