  ...
  const fetchSingleRequest = async () => {
    try {
      ...
      setIsLoading(true);
        ...
        const response = await axios.get(`/visa/application/${orderedBy}/${id}/single/${travellerId}`, {
          ...
          <div>
            <div className="p-4 grid grid-cols-2 gap-[20px]">
              <div>
                ...
                <div className="">
                  ...
                  <span className="block text-[15px]">
                    {singleVisaApplication?.visaType?.visaName}
                  </span>
                </div>
                <div className="mt-3">
                  <span className="block text-[12px] text-grayColor">
                ...
                <div className="mt-3">
                  ...
                  <span className="block text-[15px]">
                    {singleVisaApplication?.visaType?.ageFrom +
                      " - " +
                      singleVisaApplication?.visaType?.ageTo}
                  </span>
                </div>
                <div className="mt-3">
                  <span className="block text-[12px] text-grayColor">
                  ...
                  <span className="block text-[15px] capitalize">
                    {singleVisaApplication?.visaType?.entryType}
                  </span>
                </div>
                <div className="mt-3">
                  <span className="block text-[12px] text-grayColor">
                  ...
                  <span className="block text-[15px]">
                    {singleVisaApplication?.visaType?.validity +
                      " " +
                      singleVisaApplication?.visaType?.validityTimeFormat}
                  </span>
                </div>
                <div className="mt-3">
                  <span className="block text-[12px] text-grayColor">
                  ...
                  <span className="block text-[15px]">
                    {singleVisaApplication?.visaType?.stayPeriod +
                      " " +
                      singleVisaApplication?.visaType?.stayPeriodFormat}
                  </span>
                </div>
                <div className="mt-3">
                  <span className="block text-[12px] text-grayColor">
                  ...
                  <span className="block text-[15px]">
                    {singleVisaApplication?.visaType?.processingTime +
                      " " +
                      singleVisaApplication?.visaType?.processingTimeFormat}
                  </span>
                </div>
                <div className="mt-3">
                  <span className="block text-[12px] text-grayColor">
              ...
              <div>
                ...
                <span className="block text-[15px]">
                  {singleVisaApplication?.reseller?.name}
                </span>
              </div>
              <div className="mt-3">
                <span className="block text-[12px] text-grayColor">
                ...
                <span className="block text-[15px]">
                  {singleVisaApplication?.reseller?.agentCode}
                </span>
              </div>
              <div className="mt-3">
                <span className="block text-[12px] text-grayColor">
                ...
                <span className="block text-[15px] capitalize">
                  {singleVisaApplication?.reseller?.companyName}
                </span>
              </div>
              <div className="mt-3">
                <span className="block text-[12px] text-grayColor">
                ...
                <span className="block text-[15px]">
                  {singleVisaApplication?.reseller?.phoneNumber}
                </span>
              </div></>
              : <><div className="mt-3">
              <span className="block text-[12px] text-grayColor">
              ...
              <span className="block text-[15px]">
                {singleVisaApplication?.user?.name}
              </span>
            </div>
            ...
            <div className="mt-3">
              ...
              <span className="block text-[15px] capitalize">
                {singleVisaApplication?.user?.email}
              </span>
            </div>
            <div className="mt-3">
              <span className="block text-[12px] text-grayColor">
              ...
              <span className="block text-[15px]">
                {singleVisaApplication?.reseller?.phoneNumber || "N/A"}
              </span>
            </div>
            </> 
                }
                ...
                <div className="mt-3">
                  ...
                  <span className="block text-[15px]">
                    {singleVisaApplication?.createdAt?.slice(0, 10)}
                  </span>
                </div>
                {/* <div className="mt-3">
                  <span className="block text-[12px] text-grayColor">
                ...
                <div className="mt-3">
                  ...
                  <span className="text-[15px] flex items-center gap-[10px]">
                    {singleVisaApplication?.totalAmount}
                  </span>
                </div>
                <div className="mt-3">
                  <span className="block text-[12px] text-grayColor">
            ...
            <div className="overflow-x-auto">
              <table className="w-full">
                ...
                <tbody className="text-sm">
                  {singleVisaApplication?.travellers?.map((item, index) => (
                    <VisaApplicationSingleTableRow
                    orderedBy={orderedBy}
                    singleVisaApplication = {singleVisaApplication}
                      item={item}
                      key={index}
                      index={index}
                    />
