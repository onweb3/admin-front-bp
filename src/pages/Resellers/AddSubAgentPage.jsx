...
export default function AddSubAgentPage() {
    ...
    const fetchReseller = async () => {
        try {
            ...
            const response = await axios.get(`/resellers/single/${id}/basic-info`, {
                headers: { authorization: `Bearer ${jwtToken}` },
            });
            const { companyName, address, website, country, city, zipCode } = response?.data;
            setData((prev) => {
                return {
                    ...prev,
                    companyName,
    ...
    return (
        <div>
            <div className="bg-white flex items-center justify-between gap-[10px] px-6 shadow-sm border-t py-2">
                <h1 className="font-[600] text-[15px] uppercase">Add Sub Agent</h1>
                <div className="text-sm text-grayColor">
                    ...
                    <span>{">"} </span>
                    <Link to={`/b2b/${id}/sub-agents`} className="text-textColor">
                        sub agents{" "}
                    </Link>
                    <span>{">"} </span>
                    <span>Add</span>
                        ...
                        <form action="" onSubmit={handleSubmit}>
                            ...
                            <div className="mt-4 flex items-center justify-end gap-[12px]">
                                ...
                                <button className="w-[150px]">
                                    {isLoading ? <BtnLoader /> : "Add Sub Agent"}
                                </button>
                            </div>
                        </form>
                    </div>
