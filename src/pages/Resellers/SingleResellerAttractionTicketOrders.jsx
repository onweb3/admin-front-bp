...
export default function SingleResellerAttractionTicketOrdersPage() {
    ...
    const fetchAttractionTicketOrders = async ({ ...filters }) => {
        try {
            ...
            const response = await axios.get(
                `/attractions/orders/b2b/reseller/${id}/all?bookingType=ticket&${searchQuery}`,
                {
    ...
    const handleDownload = async () => {
        try {
            ...
            const response = await axios({
                url: `/attractions/orders/b2b/reseller/${id}/all/sheet?bookingType=ticket&${searchQuery}`,
                method: "GET",
                responseType: "blob",
                headers: {
