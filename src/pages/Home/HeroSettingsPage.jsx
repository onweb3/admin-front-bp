...
export default function HeroSettingsPage() {
  ...
  const fetchHeros = async () => {
    try {
      ...
      const response = await axios.get("/home/heros", {
  ...
  const deleteHero = async (id) => {
    try {
      ...
      if (isConfirm) {
        await axios.delete(`/home/heros/delete/${id}`, {
          headers: { Authorization: `Bearer ${jwtToken}` },
        });
  ...
  return (
    <div>
      <div className="bg-white flex items-center justify-between gap-[10px] px-6 shadow-sm border-t py-2">
        <h1 className="font-[600] text-[15px] uppercase">Hero Setting</h1>
              ...
              <table className="w-full">
                <thead className="bg-[#f3f6f9] text-grayColor text-[14px] text-left">
                  <tr>
                    ...
                    <th className="font-[500] p-3">Place</th>
                      ...
                      >
                        <td className="p-3">
                          <div className="flex items-center gap-[10px]">
                            <img
                              src={
                                import.meta.env.VITE_SERVER_URL + hero?.image
                              }
                              alt=""
                        ...
                        <td className="p-3">{hero?.place}</td>
                        <td className="p-3">
