...
import MarketProfileTableRow from "../../features/Market Profile/componenets/MarketProfileTableRow";

export default function MarketProfileListPage() {
    ...
    const fetchProfiles = async ({ skip, limit, name }) => {
        try {
            ...
            const response = await axios.get(
                `/market/get-all-profiles?skip=${skip}&limit=${limit}&name=${name}`,
                {
                ...
                <div className="p-6">
                    <div className="bg-white rounded shadow-sm">
                        <div className="flex items-center justify-between border-b border-dashed p-4">
                            <h1 className="font-medium">All Market Profile</h1>
