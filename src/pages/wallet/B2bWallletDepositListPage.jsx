    ...
    const fetchB2bWalletDeposits = async () => {
        try {
            ...
            const response = await axios.get(
                `/wallets/b2b/deposits/all?status=${filters.status}&paymentProcessor=${filters.paymentProcessor}&dateFrom=${filters.dateFrom}&dateTo=${filters.dateTo}&limit=${filters.limit}&skip=${filters.skip}`,
                {
