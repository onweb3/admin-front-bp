...
import AddLandingPageModal from "../../features/Seo/components/AddLandingPageModal";
    ...
    const fetchMainCategory = async () => {
        try {
            ...
            const response = await axios.get(
                `/seo/categories/${id}?skip=${filters.skip}&limit=${filters.limit}&searchQuery=${filters.searchQuery}`,
                {
            ...
            <div className="p-6">
                <div className="bg-white rounded shadow-sm">
                    <div className="flex items-center justify-between border-b border-dashed p-4">
                        <h1 className="font-medium">Seo Category - {id}</h1>
