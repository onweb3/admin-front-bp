...
export default function AddAttractionItineraryPage() {
    ...
    const handleSubmit = async (e) => {
        try {
            ...
            // const itineraries = data.itineraries.map((ele) => {
            // });

            const requestBody = { ...data };

            await axios.post(`/attractions/itineraries/add`, requestBody, {
    ...
    return (
        <div>
            ...
            <div className="p-6">
                <div className="bg-white grid grid-cols-2 gap-6 rounded p-6 shadow-sm">
                    <form action="" onSubmit={handleSubmit}>
                        ...
                        <div className="mt-4 flex items-center justify-end gap-[12px]">
                            ...
                            <button className="w-[140px]">
                                {isLoading ? <BtnLoader /> : "Add Itinerary"}
                            </button>
                        </div>
                    </form>
