              ...
              <table className="w-full">
                <thead className="bg-[#f3f6f9] text-grayColor text-[14px] text-left">
                  <tr>
                    ...
                    <th className="font-[500] p-3">Normal Occupancy</th>
                    <th className="font-[500] p-3">Airport Occupancy</th>
                  ...
                  {vehicles?.map((vehicle, index) => {
                    return (
                      ...
                      >
                        ...
                        <td className="p-3">{vehicle?.normalOccupancy}</td>
                        <td className="p-3">{vehicle?.airportOccupancy}</td>
                        <td className="p-3">
