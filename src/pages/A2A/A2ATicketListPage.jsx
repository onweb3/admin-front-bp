            ...
            <div className="bg-white rounded shadow-sm">
              <div className="flex items-center justify-between border-b border-dashed p-4">
                <h1 className="font-medium">
                  {result?.length > 0 ? (
                    <>
                      {result[0]?.airportToName} - {result[0]?.airportFromName}{" "}
                    </>
                  ) : (
                    "A2a Tickets"
                  )}
                ...
                <div>
                  <button
                    ...
                    onClick={() => navigate(`/a2a/${params.id}/add`)}
                  >
                    + Add Ticket
                  </button>
                </div>
                  ...
                  <table className="w-full">
                    <thead className="bg-[#f3f6f9] text-grayColor text-[14px] text-left">
                      <tr>
                        ...
                        <th className="font-[500] p-3">Onward Airline</th>
                        <th className="font-[500] p-3">Return Airline</th>
                        <th className="font-[500] p-3">PNR Number</th>
                        <th className="font-[500] p-3">Seats Left</th>
                        <th className="font-[500] p-3">Total Seats</th>
                    ...
                    <tbody className="text-sm text-textColor">
                      {result?.map((item, index) => (
                        <tr>
                          ...
                          <td className="p-3">{item?.pnrNo}</td>
                          <td className="p-3">{item?.availableSeats}</td>
                          <td className="p-3">{item?.totalSeats}</td>
                          <td className="p-3">
                            <div className="flex items-center gap-[10px]">
                              <p>
                                {item?.markup?.markup
                                  ? item?.markup?.markup +
                                    (item?.markup?.markupType === "percentage"
                                      ? "%"
                                      : " AED")
                                  : "N/A"}
                              </p>
