        ...
        selectedActivities: [
          {
            ...
            childrenCount: data?.childrenCount ? data?.childrenCount : 0,
      ...
      const timeSlots = response.data.map((timeSlot) => {
        return {
          ...
          displayName: `${timeSlot.EventName}-avai(${
            ...
            timeSlot.ChildPrice
          } AED)-slot(${moment(timeSlot.StartDateTime).format("h:mm A")})`,
        };
      });
    ...
    if (
      ...
      if (selectedActivity?.activityType === "transfer") {
        if (data?.value === "private") {
          const sortedPvtTransfers = selectedActivity.privateTransfers.sort(
          ...
          if (selectedActivity.base === "hourly") {
            ...
            calculatedAdultPrice =
              selectedActivity?.sharedTransferPrice * data?.adultsCount;
            calculatedChildPrice =
              selectedActivity?.sharedTransferPrice * data?.childrenCount;
            calculatedInfantPrice =
              selectedActivity?.sharedTransferPrice * data?.infantCount;
          }
        }
  ...
  return (
    <div>
      <div className="bg-white flex items-center justify-between gap-[10px] px-6 shadow-sm border-t py-2">
        <h1 className="font-[600] text-[15px]">Create Attraction Order</h1>
            ...
            <div className="grid grid-cols-3 gap-4">
              ...
              <div>
                ...
                >
                  ...
                  {selectedActivity?.activityType === "normal" && (
                ...
                <div>
                  ...
                  <div className="">
                    <SelectDropdown
                      ...
                      selectedData={data?.selectedSlot?.EventID}
                      setSelectedData={(value) =>
                        handleSingleChange({
                          name: "selectedSlot",
                          value: value,
                  ...
                  <div className="flex items-top gap-2 ">
                    <div>
                      <div className="grid grid-cols-3 p-5 gap-2">
                        ...
                        <div>
                          <label htmlFor="">Agent Reference Number</label>
                          <input
                            type="text"
                            placeholder="Enter Agent Reference Numbe"
                            name="agentReferenceNumber"
                            value={data.agentReferenceNumber || ""}
                            onChange={handleChange}
                            required
                          />
                        </div>{" "}
                    ...
                    <div className="p-8 flex justify-center items-center">
                      <div class="max-w-sm rounded overflow-hidden shadow-lg">
                        <img
                          class="w-full"
                          src={
                            selectedActivity?.attraction?.images[0]
                        ...
                        <div class="px-6 py-4 w-full">
                          ...
                          <div class="font-bold text-md mb-2 text-gray-500">
                            {selectedActivity?.attraction?.title}
                          </div>
                          ...
                          {data?.adultsCount > 0 &&
                            ((data?.value !== "private" &&
                              selectedActivity.activityType == "transfer") ||
                              selectedActivity.activityType !== "transfer") && (
                              <div class="text-gray-700 text-base flex gap-4  items-center justify-between ">
                                <div className="flex">Adult</div>
                                <div className="flex">{data?.adultsCount}</div>
                                {selectedActivity.base === "hourly" && (
                                  <div className="flex">{data?.hoursCount}</div>
                                )}
                                <div className="flex">
                          ...
                          {data?.value === "private" && (
                            <div class="text-gray-700 text-base flex gap-4  items-center justify-between ">
                              <div className="flex">Pvt Transfer</div>
                              {/* <div className="flex">
                                                                "N/A"
                                                            </div> */}
                              <div> </div>
                        ...
                        <div class="px-6 pb-2">
                          <div className="mt-4 flex items-center justify-end gap-[12px]">
                            <button className="w-[120px]  rounded-md">
