    ...
    try {
      ...
      for (
        ...
        for (
          let j = 0;
          j <
          quotationList?.transferQuotation?.stayTransfers[i]?.transfers?.length;
          j++
        ) {
          let transfer =
            quotationList?.transferQuotation.stayTransfers[i].transfers[j];
  ...
  return (
    <div className="bg-white">
      {isLoading ? (
        ...
        <div style={{ fontFamily: "Poppins" }} className="p-10 text-[12px] ">
          ...
          >
                  ...
                  <tr>
                    ...
                    >
                      {quotationList.checkInDate &&
                        new Date(quotationList?.checkInDate).toDateString()}
                    </td>
                  </tr>
                  <tr>
                    <td
                    ...
                    >
                      {quotationList.checkOutDate &&
                        new Date(quotationList?.checkOutDate).toDateString()}
                    </td>
                  </tr>
                  <tr>
                    <td
                    ...
                    <div className="mt-5 text-[15px] cust-border">
                      {quotationList?.noOfAdults && (
                        <div>
                          ...
                          {quotationList?.perPersonAdultPrice?.toFixed(2)}{" "}
                          {quotationList?.quotationCurrency}
                        </div>
                      )}
                      {quotationList?.noOfChildren > 0 ? (
                        <div className="mt-1">
                          ...
                          {quotationList?.perPersonChildPrice?.toFixed(2)}{" "}
                          {quotationList?.quotationCurrency}
                        </div>
                      ) : (
                        ""
            ...
            <div className="cust-border">
              <div className="cust-border">
                {quotationList?.excursionQuotation?.excursions?.length ? (
                  <div>
                          ...
                          <ul className="list-disc ml-6 text-[12px]">
                            <li className="cust-border">
                              ...
                              <span className="capitalize">
                                {exc?.excursionType.toLowerCase() === "ticket"
                                  ? exc?.value.toLowerCase() === "ticket"
                                    ? "Only Ticket"
                                    : exc?.value.toLowerCase() === "shared"
                                    ? "Tickets With SIC Transfer"
                                    : exc?.value.toLowerCase() === "private"
                            ...
                            <ul className="list-disc ml-6 text-[12px]">
                              ...
                              {transfer.transferType === "city-city" && (
                                <li className="cust-border">
                                  ...
                                  {transfer?.transferToHubName} - Private
                                  Transfer
                                </li>
                              )}
                                  ...
                                  {transfer?.transferFrom.map((from, i) => {
                                    return (
                                      <>
                                        ...
                                        {i !==
                                          transfer.transferFrom.length - 1 && (
                                          <span className="cust-border">/</span>
                                        )}
                                      </>
                                    );
            ...
            <div className="cust-border">
              <div className="cust-border">
                {quotationList?.excSupplementQuotation?.excursions?.length ? (
                  <div className="cust-border">
                    <h3 className=" text-[12px] font-bold pt-5 cust-border">
                      Optional Tours Cost
                    </h3>
                          ...
                          <ul className="list-disc ml-6 text-[12px]">
                            <li className="cust-border">
                              ...
                              <span>
                                {" "}
                                - (Adult -{" "}
                                {quotationList?.quotationCurrency === "AED"
                                  ? exc?.adultPrice
                                  : (exc?.adultPrice / 3.65)?.toFixed(0)}{" "}
                                {quotationList?.quotationCurrency}, Child -{" "}
                                {quotationList?.quotationCurrency === "AED"
                                  ? exc?.childPrice
                                  : (exc?.childPrice / 3.65)?.toFixed(0)}{" "}
                                {quotationList?.quotationCurrency})
                              </span>
                            </li>
                          </ul>
            ...
            <div className="cust-border">
              ...
              <ul className="list-disc ml-6 text-[12px]">
                <li className="cust-border">
                  ...
                  {new Date(
                    new Date(quotationList?.createdAt).setDate(
                      new Date(quotationList?.createdAt).getDate() + 2
                    )
                  ).toDateString()}
                </li>
                <li className="cust-border">
                  The above rates are subject to change as per hotel's inputs.
                  This could be due to withdrawal of promotional by the Hotel or
                  currency fluctuation or any additional taxes or toll
                  implemented by the Government.
                </li>
                <li className="cust-border">
                  Accommodation for Child as stated is as per the child policy
                  of the respective Hotel. Child below 02 Years Is considered as
                  an infant and from 02 years to 12 years as a child.
                </li>
                <li className="cust-border">
                  Above package rate is subject to availability of rooms and
                  offered inclusions and is subject to change as per
                  availability at the time of booking. Kindly reconfirm with our
                  team before confirming to the client.
                </li>
                <li className="cust-border">
                  Cancellation charges are applicable as per the Hotel policy.
                  NRF rates are subject to 100% cancellation charges.
                </li>
                <li className="cust-border">
                  All the services included in the package are compulsory and no
                  refund will be given if any of the services are not taken.
                </li>
                <li className="cust-border">
                  Tourism Dirham which has been levied by the hotels in Dubai,
                  same has to be paid directly by the guest at the hotel upon
                  check-in.
                </li>
                <li className="cust-border">
                  Please Note the Check-In time is 3:00 PM And check out time Is
                  12:00 PM. Early Check-In or Late Check-Out Is depending upon
                  Hotel room availability and may be subject to an extra charge.
                </li>
                <li className="cust-border">
                  Rooms And Rates Are Subject To Availability At The Time Of
                  Booking Confirmation kindly reconfirm before the booking.
                </li>
              </ul>
            </div>
