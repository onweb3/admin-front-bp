...
import { VoucherDailyReportTable, VoucherV2DailyReportsTable } from "../../features/Voucher";

export default function VouchersV2DailyReportPage() {
    ...
    const handleDownloadExcelByTourType = async () => {
        try {
            let response = await axios({
                url: `/v2/vouchers/tour-type/excel/download?fromDate=${filters.fromDate}&toDate=${filters.toDate}&referenceNumber=${filters.referenceNumber}`,
                method: "GET",
                responseType: "blob",
                headers: {
                    authorization: `Bearer ${jwtToken}`,
