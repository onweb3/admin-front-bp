...
import {  VouchersTableV2 } from "../../features/Voucher";
import { hasPermission } from "../../utils";

export default function VouchersV2ListPage() {
    ...
    const fetchVouchers = async ({ ...filters }) => {
        try {
            ...
            const response = await axios.get(
                `/v2/vouchers/all?skip=${filters.skip}&limit=${filters.limit}&filterBy=${filters.filterBy}&fromDate=${filters.fromDate}&toDate=${filters.toDate}&referenceNumber=${filters.referenceNumber}`,
                {
    ...
    return (
        <div>
            <div className="bg-white flex items-center justify-between gap-[10px] px-6 shadow-sm border-t py-2">
                <h1 className="font-[600] text-[15px] uppercase">Tour Schedules</h1>
                ...
                <div className="bg-white rounded shadow-sm">
                    <div className="flex items-center justify-between border-b border-dashed p-4">
                        ...
                        <div className="flex items-center gap-[10px]">
                            ...
                            {hasPermission({
                                ...
                                <Link to={`add`}>
                                    <button className="px-3">+ Add Voucher</button>
                                </Link>
                            )}
                        </div>
                    </div>
                    ...
                    >
                        ...
                        <div className="">
                            ...
                            <select name="filterBy" id="" onChange={handleChange}>
                                <option value="createdAt">Created At</option>
                                <option value="checkInDate">ChekckIn Date</option>
