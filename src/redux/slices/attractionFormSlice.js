  ...
  reducers: {
    ...
    handleInitiateLocalStorageData: (state, { payload }) => {
      ...
      state.data = {
        ...
        bookingType: payload?.attrData?.bookingType || "ticket",
        destination: payload?.attrData?.destination || "",
        category: payload?.attrData?.category || "",
        durationType: payload?.attrData?.durationType || "hours",
        duration: payload?.attrData?.duration || "",
        mapLink: payload?.attrData?.mapLink || "",
        isOffer: payload?.attrData?.isOffer || false,
        offerAmountType: payload?.attrData?.offerAmountType || "flat",
        offerAmount: payload?.attrData?.offerAmount || "",
        isApiConnected: payload?.attrData?.isApiConnected || false,
        connectedApi: payload?.attrData?.connectedApi || "",
        cancellationType:
          payload?.attrData?.cancellationType || "nonRefundable",
        cancelBeforeTime: payload?.attrData?.cancelBeforeTime || "0",
        cancellationFee: payload?.attrData?.cancellationFee || "",
        isCustomDate: payload?.attrData?.isCustomDate || false,
        ...
        isCombo: payload?.attrData?.isCombo || false,
        ...
        displayOrder: payload?.attrData?.displayOrder || 1,
